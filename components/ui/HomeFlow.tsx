...
export default function HomeFlow() {
  return (
    <div className="bg-[rgb(var(--bg-main))] theme-sync min-h-screen">
      ...
      <section className="py-40 md:py-64 flex flex-col items-center px-8">
        <motion.div 
          ...
          viewport={{ once: true, amount: 0.5 }} // High amount for the line
        ...
        <div className="max-w-[1400px] mx-auto relative">
          ...
          <div className="flex justify-start mb-48">
            <motion.div 
              ...
              viewport={{ once: true, amount: 0.1 }} // Triggers early, stays forever
